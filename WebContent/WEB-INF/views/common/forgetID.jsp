...
<div class="card border-success mb-3" style="width:500px;height:500px; margin:0 auto;">
 	<div class="card-header"style="text-align:center; height:100px;">아이디를 잊으셨나요?
  ...
  <div class="card-body text-success" style="height:400px;">
      ...
      <div class="input-group" style="width:400px; ">
        <span style="text-aline:center; margin-left:30px;">이름</span>
        ...
        <span class="input-group-append">
  		 ...
  		 <div class="card-footer" style="background-color:white; padding:20px;">
      <div class="input-group" style="width:400px; ">
        <span style="text-aline:center; margin-left:30px;">전화번호</span>
        <input type="text" name="id" placeholder="전화번호를 '-'을 제외하고 입력해주세요" >
        <span class="input-group-append">
        </span>
      </div>
    </div>
	...
	<button type="button" class="btn btn-block btn-success btn-sm" style="width:150px; height:40px; margin:0">찾기</button>
  </div>
  </div>
