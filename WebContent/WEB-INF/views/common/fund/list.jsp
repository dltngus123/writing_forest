  		...
  		<div id="keyword" class="card-tools" style="width:600px; ">
   					 <div class="input-group row">
					 	...
					 	<select class="form-control col-md-4" name="searchType" id="searchType">
					 		...
					 		<option value="md" ${cri.orderBy=='md' ? 'selected' : '' }>높은 퍼센트순</option>
					 		<option value="dd" ${cri.orderBy=='dd' ? 'selected' : '' }>최신순</option>
					 		<option value="da" ${cri.orderBy=='da' ? 'selected' : '' }>마감임박순</option>
						</select>
						<!-- keyword -->
