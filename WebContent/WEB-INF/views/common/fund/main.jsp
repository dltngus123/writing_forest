 ...
 <div class="content-wrapper">
  		...
  		<div id="keyword" class="card-tools" style="width:600px; ">
   					 <div class="input-group row">
					  	...
					  	<!-- search bar -->
					 	<select class="form-control col-md-4" name="orderBy" id="orderBy">
					 		<option value="">검색구분</option>
					 		<option value="" ${cri.orderBy=='md' ? 'selected' : '' }>높은 퍼센트순</option>
					 		<option value="" ${cri.orderBy=='dd' ? 'selected' : '' }>최신순</option>
					 		<option value="" ${cri.orderBy=='da' ? 'selected' : '' }>마감임박순</option>			 						
						</select>
						<!-- keyword -->
      	...
      	<div id="downwrap" >
      		...
      		<div id="bestfund-layout"class="col-lg-12">
      			<h5>핫한 펀딩</h5>
      			<div id="inerlayout">
      			<c:forEach items="${fundingList }" end="5">
