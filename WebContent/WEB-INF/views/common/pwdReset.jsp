...
<div class="card border-success mb-3" style="width:500px;height:500px; margin:0 auto;">
 	<div class="card-header"style="text-align:center; height:100px;">비밀번호를 재설정합니다.
  ...
  <div class="card-body text-success" style="height:400px;">
      ...
      <div class="input-group" style="width:400px; ">
        <span style="text-aline:center; margin-left:10px;">비밀번호</span>
        <input type="text" name="id" placeholder="비밀번호를 입력해주세요" >
        <span class="input-group-append">
  		 ...
  		 <div class="card-footer" style="background-color:white; padding:20px;">
      <div class="input-group" style="width:400px; ">
        <span style="text-aline:center; margin-left:-10px;">비밀번호 재확인</span>
        <input type="text" name="id" placeholder="비밀번호를 다시 한번 입력해주세요" >
