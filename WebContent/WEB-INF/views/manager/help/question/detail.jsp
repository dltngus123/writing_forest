      ...
      <div class="content-wrapper">
      	...
      	<div id="downwrap" >
      		...
      		<div class="col-lg-12" style=" display:flex;">
      			...
      			<a href="<%=request.getContextPath() %>/manager/help/notice/list.do" >공지사항</a>
      			</div>
      			<div class="col-sm-4" style="text-align:center; ">
				<a href="<%=request.getContextPath() %>/manager/help/fnq/list.do">자주묻는 질문</a>
				</div>
      			<div class="col-sm-4" style="text-align:center; ">
      			<a href="<%=request.getContextPath() %>/manager/help/question/list.do">문의하기</a>
      			</div>
      		</div>
      			<hr/>
      		<div class="col-md-12" id="questsion" >
				...
				<a href="list.do" style="color:inherit;margin-left:1200px;">목록</a>
				</div>
				</div>
				 ...
				 <div class="comment_setting" style="text-align:right;">
					...
					<div class="cont_info">
					    <div class="info_append">
					     ...
					     <form role="form" >
					    <div id="coment" class="col-md-12" style="display:flex; ">
					    <input type="hidden" name="manager_id" value="${loginUser.member_id }"/>
					  	<input type="hidden" name="q_num" value="${question.q_num}"/>
					  	<input type="text" name="q_answer" value="${question.q_answer}" placeholder="답변을 남겨주세요."/>
					
				<div id="button">
				    <input id="regist_button" type="submit" class="btn" onclick="regist_go();" value="등록" style="background-color: rgba(100, 183, 0, 0.75); color: white; margin-left: 5px;"/>
				</div>
				<div id="modifybutton">
				    <input id="modify_button" type="button" class="btn" onclick="regist_go();" value="수정"  style="background-color: rgba(100, 183, 0, 0.75); color: white; "/>
				    
				    <button id="remove_button" class="btn" onclick="remove_go();" style="background-color: rgb(192, 57, 43); color: white;">삭제</button>
				</div>
      	...
      	function remove_go(){
      	 ...
      	 function regist_go(){
      		formObj.attr('action','regist.do').submit();	
         }
        ...
        if (!q_answer) {
        	  document.getElementById("modifynremove").style.display = "none";
        	}
