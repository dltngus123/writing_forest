...
<c:forEach var="i" begin="1" end="6">
    ...
    <div class="md-12" id="random-member">
        <c:forEach var="i" begin="1" end="5">
            ...
            <c:if test="${i <= memberList.size() and not memberList[randomIndex].member_id and memberList[randomIndex].member_authority == 2 and memberList[randomIndex].member_id != loginuser.member_id}">
                <span class="md-2">
