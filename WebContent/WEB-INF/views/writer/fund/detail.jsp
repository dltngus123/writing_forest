...
<div class="card-body row">
   <div id="navbar"class="col-md-12"  >
      ...
      <div id="img" style="font-size:0.5rem; font-weight: bold;"><img  src="<%=request.getContextPath() %>/common/getimg.do?member_id=${funding.member_id}" style="width: 50%; height: 50%; odject-fit:cover;border-radius: 50%;">${funding.member_id }</div>
      </div>
      <div class="col-md-2 btn" style="font-size:0.5rem;">조회수(${funding.fun_view })</div>
      <div class="col-md-1 btn" style="font-size:0.5rem;"  onclick="subs_go();">구독</div>
      <a style="font-size:0.5rem;" href="<%=request.getContextPath()%>/common/fund/list.do"class="col-md-1 btn">목록</a>
      <div  style="font-size:0.5rem;"class="col-md-1 btn" onclick="notify_go();">신고</div>
      </div>
...
<div class="col-5 text-center d-flex align-items-center justify-content-center">
 ...
 <div id="img"><img  src="<%=request.getContextPath() %>/writer/fund/getPicture.do?fun_num=${funding.fun_num}" style=" border:1px solid black;width: 300px; height: 300px; odject-fit:cover;"></div>
...
<hr/>
 <div id="commentlist" class="col-md-8" style="text-align:center;">
  <ul class="list_comment" style="list-style-type:none;">
    <c:forEach items="${reply}" var="reply">
      ...
      <li class="item animation_up">
        <div class="comment">
          ...
          <a href="#" class="link_profile">
            <img src="<%=request.getContextPath()%>/common/getimg.do?member_id=${reply.member_id}" width="42" height="42" class="img_thumb">
          </a>
          <div class="cont_info">
            <div class="info_append">
              <strong class="tit_userid">
                <a href="#" class="link_userid">${reply.member_id}</a>
              </strong>
              <span class="ico_dot"></span>
              <span class="txt_time" style="margin-left:20px;"><fmt:formatDate value="${reply.reply_date}" pattern="yyyy-MM-dd"/></span>
            </div>
            <p class="desc_comment" style="margin-left:10px;">${reply.reply_content}</p>
          </div>
          <hr/>
        </div>
      </li>
      ...
      <div id="coment" class="col-md-12" style="display:flex; justify-content:center; margin-bottom:20px;" >
...
var formObj="";
   ...
   function regist_go(){
      ...
      if(answer) formObj.attr('action','payregist.do').submit(); 
