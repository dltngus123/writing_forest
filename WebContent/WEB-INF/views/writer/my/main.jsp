        ...
        <thead>
            ...
            <td>
               <div id="img" style="width: 100px; height: 100px;">
                  <img src="<%=request.getContextPath() %>/writer/write/getimg.do?writing_num=${writing.writing_num}" style="width: 100%; height: 100%; odject-fit:cover; rgba:0,0,0,80;">
               </div>
            </td>
            <td><a href="<%=request.getContextPath() %>/writer/write/detail.do?writing_num=${writing.writing_num}">${writing.writing_title }</a></td>
            <td>${writing.writing_stitle }</td>
