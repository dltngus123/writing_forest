...
public class ManagerQuestionDetailAction implements Action {
...
private QuestionService questionservice;
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		String url="/WEB-INF/views/manager/help/question/detail.jsp";
		...
		if (from!= null && from.equals("list")) {
			...
			url="redirect:/manager/help/question/detail.do?q_num="+q_num;
		}else {
